  ...
  useEffect(() => {
    const fetchStats = async () => {
      ...
      try {
        ...
        const attendanceRecords = await pb.collection('attendance').getList(1, 1, {
        ...
        if (resultRecords.items.length > 0) {
          setStats(prev => ({
            ...prev,
            lastRank: resultRecords.items[0].rank || 0
          }));
        }
      } catch (error) {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Access your attendance, results, and academic information" />
      </Helmet>
      ...
      <div className="min-h-screen bg-muted/30">
        ...
        >
          <div className="p-6 border-b">
            <div className="flex items-center gap-3 mb-4">
              {currentUser?.photo ? (
                <img
                  src={pb.files.getUrl(currentUser, currentUser.photo)}
        ...
        <main className="lg:ml-60 pt-20 lg:pt-8 p-4 sm:p-6 lg:p-8">
          ...
          <div className="mb-8 p-6 rounded-2xl" style={{ background: 'linear-gradient(135deg, #1A3C8F 0%, #2563eb 100%)' }}>
            ...
            <p className="text-white/90">Here's your academic overview</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <Card>
              <CardContent className="p-6">
                ...
                <div className="text-sm font-medium">This Month Attendance</div>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="text-sm font-medium">Total Present Days</div>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="text-xs text-muted-foreground mt-1">
                  {stats.pendingFee === 0 ? 'All clear' : 'Payment due'}
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="hover:shadow-lg transition-all duration-300 cursor-pointer" onClick={() => navigate('/attendance')}>
              <CardHeader>
            ...
            <Card className="hover:shadow-lg transition-all duration-300 cursor-pointer" onClick={() => navigate('/results')}>
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-lg">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  View and download your exam results and report cards
                </p>
              </CardContent>
            </Card>

            <Card className="hover:shadow-lg transition-all duration-300 cursor-pointer" onClick={() => navigate('/#notices')}>
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-lg">
                  <Bell className="w-5 h-5" style={{ color: '#1A3C8F' }} />
                  Latest Notice
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  Read important announcements and school notices
                </p>
              </CardContent>
            </Card>
          </div>
